...
export default function AgendarCitaPage() {
    ...
    return (
        <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(0,96,170,0.14),_transparent_26%),linear-gradient(180deg,_#f4f8fc_0%,_#eef3f8_100%)] px-4 py-8 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <div className="mb-8 flex flex-col gap-4 rounded-[2rem] border border-white/60 bg-white/88 p-6 shadow-[0_24px_70px_rgba(7,28,52,0.1)] backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <Link
                            href="/"
                        ...
                        <h1 className="mt-3 font-serif text-4xl font-bold text-foreground sm:text-5xl">Agendar cita</h1>
                    ...
                    <div className="grid grid-cols-3 gap-3 text-center">
                        {[1, 2, 3].map((item) => (
                            <div key={item} className="min-w-24 rounded-2xl border border-border bg-muted/40 px-4 py-3">
                                <div
                ...
                <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
                    <section className="rounded-[2rem] border border-white/60 bg-white/92 p-6 shadow-[0_18px_55px_rgba(7,28,52,0.08)] sm:p-8">
                        {step === 1 ? (
                            <>
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            className="min-h-28 w-full rounded-2xl border border-border bg-white px-4 py-3 outline-none transition-all focus:border-primary focus:ring-4 focus:ring-primary/12"
                        ...
                        {step === 2 ? (
                            <>
                                ...
                                <div className="rounded-3xl border border-border bg-muted/25 p-4 sm:p-5">
                                    ...
                                    <div className="grid grid-cols-7 gap-2 text-center text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">
                                        {weekDays.map((day) => (
                                        ...
                                        {calendarDays.map((date, index) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`h-12 rounded-2xl border text-sm font-medium transition-all ${selected ? "border-primary bg-primary text-primary-foreground" : available ? "border-border bg-white text-foreground hover:border-primary hover:text-primary" : past ? "border-border/40 bg-muted/50 text-muted-foreground/60" : "border-border/50 bg-slate-100 text-muted-foreground"}`}
                                                >
                                                    {date.getDate()}
                                                </button>
                                            );
                                        ...
                                        <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-4">
                                            {availableSlots.map((slot) => (
                                                <button
                                                    ...
                                                    className={`rounded-2xl border px-4 py-3 text-sm font-medium transition-all ${selectedTime === slot.time ? "border-primary bg-primary text-primary-foreground" : slot.available ? "border-border bg-white text-foreground hover:border-primary hover:text-primary" : "cursor-not-allowed border-border/50 bg-slate-100 text-muted-foreground"}`}
                                                >
                                                    {slot.time}
                                                </button>
                                            ))}
                            ...
                            <>
                                ...
                                <div className="grid gap-4 rounded-3xl border border-border bg-muted/25 p-5 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 font-semibold text-foreground">{form.consultationType}</p>
                                    </div>
                                    <div>
                        ...
                        {error ? (
                            <div className="mt-6 rounded-2xl border border-secondary/15 bg-secondary/8 px-4 py-3 text-sm font-medium text-secondary">
                                {error}
                            </div>
                        ) : null}
                    ...
                    <aside className="space-y-6">
                        <div className="rounded-[2rem] border border-white/60 bg-[linear-gradient(180deg,_rgba(8,28,47,0.98)_0%,_rgba(0,96,170,0.94)_100%)] p-6 text-white shadow-[0_24px_70px_rgba(7,28,52,0.14)]">
                            <p className="text-sm uppercase tracking-[0.24em] text-white/64">Tu reserva</p>
                            <h2 className="mt-3 text-3xl font-semibold">Agenda clinica</h2>
