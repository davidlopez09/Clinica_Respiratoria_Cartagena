        ...
        <section id="inicio" className="relative min-h-[90vh] flex items-center overflow-hidden">
            ...
            <div className="absolute inset-0 bg-primary">
                ...
                <div
                    className="absolute inset-0"
                    style={{
                        background: `linear-gradient(90deg, rgba(8, 17, 28, ${heroOverlay.side}) 0%, rgba(8, 17, 28, ${heroOverlay.center}) 44%, rgba(8, 17, 28, ${heroOverlay.edge}) 100%)`,
                    }}
                />
                <div
                    className="absolute inset-0"
                    style={{
                        background: `linear-gradient(180deg, rgba(8, 17, 28, ${heroOverlay.top}) 0%, rgba(8, 17, 28, 0) 38%, rgba(8, 17, 28, ${heroOverlay.bottom}) 100%)`,
                    }}
                />
                <div
                    className="absolute inset-y-0 left-0 w-full max-w-[42rem]"
                    style={{
                        background: `linear-gradient(90deg, rgba(11, 30, 51, ${heroOverlay.panel}) 0%, rgba(11, 30, 51, 0.18) 55%, rgba(11, 30, 51, 0) 100%)`,
                    }}
                />
                <div className="absolute left-[8%] top-[12%] h-56 w-56 rounded-full bg-secondary/18 blur-3xl" />
            </div>
                ...
                <div className="max-w-3xl">
                    ...
                    >
                        ...
                        <p className="text-lg text-white/90 mb-8 leading-relaxed max-w-xl">
                            Atención multidisciplinaria para niños y adultos con énfasis en educación, prevención e
                            investigación de enfermedades respiratorias y alergias.
