...
const specialists = [
    ...
    },
    {
        ...
        credentials: ["Universidad Nacional Autónoma de México", "Especialista en Alergología e Inmunología Clínica"],
        location: "Cartagena - México",
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                >
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        Contamos con un equipo de médicos altamente capacitados, con formación internacional y años de
                        experiencia en sus áreas de especialización.
                    </p>
                </motion.div>
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="relative w-24 h-24 mx-auto mb-6">
                                    <div
                                        className={`absolute inset-0 bg-gradient-to-br ${specialist.color} rounded-full opacity-20`}
                                    />
